...
export default {
  ...
  data: function() {
    return {
      dataForm: {},
      notes: [
        { id: 1, title: "NathanaelGT", description: "Halo, nama saya BuSet" },
        { id: 2, title: "Halo", description: "Welcome back" }
      ]
    };
  },
  components: {
  ...
  methods: {
    newNote() {
      this.dataForm = { id: null, title: "", description: "" };
    },

    saveNote(title, description) {
      // let id;
      // if (this.notes.length) id = this.notes[this.notes.length - 1].id + 1;
      // else id = 1;
